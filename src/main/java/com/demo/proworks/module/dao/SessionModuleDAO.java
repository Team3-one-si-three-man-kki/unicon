...
public class SessionModuleDAO extends com.demo.proworks.cmmn.dao.ProworksDefaultAbstractDAO {
	 ...
	 * @return List<SessionModuleDetailVo> 해당 세션의 모듈 상세 목록
	 * @throws ElException
	 */
	public List<SessionModuleDetailVo> selectListSessionModuleDetailBySessionId(String sessionId) throws ElException {
		return (List<SessionModuleDetailVo>) list("com.demo.proworks.module.selectListSessionModuleDetailBySessionId",
				sessionId);
	}
